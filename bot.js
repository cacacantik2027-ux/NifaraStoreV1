...
const DEFAULT_SITE_TEXTS = {
  ...
  videoEyebrow       : 'Lihat langsung',
  videoTitle         : 'Sekilas tentang Nifara Store',
  videoDesc          : 'Video singkat cara kerja toko — dari memilih produk sampai chat dengan admin.',
...
const SITE_TEXT_FIELDS = [
  ...
  { key: 'videoEyebrow',      cat: 'video', label: 'Label kecil di atas judul video' },
  { key: 'videoTitle',        cat: 'video', label: 'Judul bagian video' },
  { key: 'videoDesc',         cat: 'video', label: 'Deskripsi bagian video', multiline: true },
